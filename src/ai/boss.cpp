...
const Boss Boss::LVL1MINI(Texture::ENEMYTEMP,
	...
	switch (boss->phase) {
		case 0:
			//			if (boss->cycle(1000, 10) || boss->cycle(1000,
			//510))
			...
			//				boss->moveTo({200, -200}, 100, QUICK);
			//			if (boss->cycle(250, 100) || boss->cycle(250,
			//150) ||
			//					boss->cycle(250, 200))
			//				boss->fireBullets(
			...
			//				boss->fireBullets(BulletInfo([](EntityBullet*
			//bullet) {
		...
		case 1:
			...
			//							BulletInfo(
			//									Bullet::BASIC8,
			//Texture::ROUNDBLUE, Pattern::CIRCLE16, 3),
			//							boss->getAge());
			//			}
			break;
	}
