...
List<BulletInfo> get(Pattern pattern) {
  switch (pattern) {
    ...
    case PATTERN_SINGLE8:
			return BulletInfo{AI_BASIC8} << BulletInfo{AI_BASIC8, 0};

    case PATTERN_SHOTGUN8X3:
			return BulletInfo{AI_BASIC8} << BulletInfo{AI_BASIC8, 20}
																	 << BulletInfo{AI_BASIC8, -20};

    case PATTERN_SHOTGUN10X3:
			return BulletInfo{AI_BASIC10} << BulletInfo{AI_BASIC10, 20}
																		<< BulletInfo{AI_BASIC10, -20};

    case PATTERN_SHOTGUN12X3:
			return BulletInfo{AI_BASIC12} << BulletInfo{AI_BASIC12, 20}
																		<< BulletInfo{AI_BASIC12, -20};
