  ...
  case ENEMY_SIMPLESHOTGUN_TOP_LEFT:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 5, [](EntityEnemy *enemy) {
          ...
          if (enemy->getAge() == 180) {
            enemy->fireBullets(PATTERN_SHOTGUNX3, AI_BASIC2,
                               TEXTURE_BULLET_ROUND_AQUA);
            SFX::playSound(SFX_EXPL_LIGHT1, 25);
          }
          if (enemy->getAge() == 270) {
            enemy->fireBullets(PATTERN_SHOTGUNX3, AI_BASIC2,
                               TEXTURE_BULLET_ROUND_AQUA);
    ...
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 100, [](EntityEnemy *enemy) {
          ...
          if (enemy->cycle(350, 175)) {
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC8,
                               TEXTURE_BULLET_ROUND_AQUA, 90);
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC10,
                               TEXTURE_BULLET_ROUND_AQUA, 90);
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC12,
                               TEXTURE_BULLET_ROUND_AQUA, 90);
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC8,
                               TEXTURE_BULLET_ROUND_AQUA, 270);
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC10,
                               TEXTURE_BULLET_ROUND_AQUA, 270);
            enemy->fireBullets(PATTERN_SHOTGUNX5, AI_BASIC12,
                               TEXTURE_BULLET_ROUND_AQUA, 270);
            SFX::playSound(SFX_EXPL_MED2, 25);
          }
  ...
  case ENEMY_SIMPLESHOTGUN_MID_LEFT_UP:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 40, [](EntityEnemy *enemy) {
          ...
          if (enemy->getAge() == 155) {
            enemy->fireBullets(PATTERN_SHOTGUNX3, AI_BASIC8,
                               TEXTURE_BULLET_ROUND_AQUA);
            SFX::playSound(SFX_EXPL_LIGHT1, 25);
          }
          if (enemy->getAge() == 275) {
  ...
  case ENEMY_DIVER:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 40, [](EntityEnemy *enemy) {
          ...
          if (enemy->cycle(50)) {
            enemy->fireBullets(PATTERN_CIRCLE16, AI_FLOWER,
  ...
  case ENEMY_LARGE_SLOW_RIGHTTOLEFT:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 80, [](EntityEnemy *enemy) {
          ...
          if (enemy->cycle(150)) {
            enemy->fireBullet(BulletInfo(), AI_ACCELERATING,
                              TEXTURE_BULLET_ROUND_RED, 0, { 0, 0 }, 6);
            SFX::playSound(SFX_MISSILE2, 25);
          }
          if (enemy->getAge() == 1000) // 15 seconds plus off screen
            enemy->deleteLater();
        });
  ...
  case ENEMY_small_fast_RIGHTTOLEFT:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 80, [](EntityEnemy *enemy) {
          ...
          if (enemy->cycle(50)) {
            enemy->fireBullets(PATTERN_CIRCLE16, AI_BASIC5,
                               TEXTURE_BULLET_ELLIPSE_RED);
            SFX::playSound(SFX_EXPL_LIGHT3, 25);
          }
  ...
  case ENEMY_small_fast_TOPDOWNTOLEFT:
    entity =
        new EntityEnemy(TEXTURE_ENEMYTEMP, uuid, 80, [](EntityEnemy *enemy) {
          ...
          if (enemy->cycle(1))
            enemy->fireBullets(PATTERN_CIRCLE8, AI_ACCELERATING,
                               TEXTURE_BULLET_ELLIPSE_RED);
          if (enemy->getAge() == 1000) // 15 seconds plus off screen
            enemy->deleteLater();
        });
