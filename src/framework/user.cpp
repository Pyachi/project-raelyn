...
User::User()
  ...
  for (const QHostAddress& address : QNetworkInterface::allAddresses()) {
    if (address.protocol() == QAbstractSocket::IPv4Protocol &&
        ...
        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-04 10:43:12","yyyy-MM-dd HH:mm:ss"), 2000);
        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-05 10:43:12","yyyy-MM-dd HH:mm:ss"), 2500);
        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-06 10:43:12","yyyy-MM-dd HH:mm:ss"), 2250);
        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-07 10:43:12","yyyy-MM-dd HH:mm:ss"), 1500);
        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-08 10:43:12","yyyy-MM-dd HH:mm:ss"), 3000);

        score->Add_Score("hello", "brad", QDateTime::fromString("2021-10-09 10:43:12","yyyy-MM-dd HH:mm:ss"), 1700);
